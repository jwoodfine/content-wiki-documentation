...
(WORM) y está anclado mediante [[merkle-proofs-as-substrate-primitive|cadenas de prueba Merkle]] conforme a RFC 9162.

---

## Emparejamiento de Máquinas como Ceremonia de Acuñación de Capacidades

El [[pairing-as-permission|emparejamiento de máquinas]] F11 en [[os-console-architecture|os-console]] es la ceremonia de acuñación de
...
el sustrato de capacidades en Rust. La [[topic-three-binary-architecture|arquitectura de tres binarios]]
