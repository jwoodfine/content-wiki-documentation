...
Esto refleja la experiencia del cliente: un miembro de la comunidad o un cliente abre un [[totebox-archive|archivo Totebox]] a través de [[os-console|`os-console`]]. El flujo de trabajo de desarrollo utiliza el mismo punto de entrada, adaptado al espacio de trabajo.
...
Este es el nivel de permiso propio del colaborador, un concepto distinto del rol que otorga
un token de emparejamiento de un archivo individual (véase [[pair-a-new-device]]) — el nivel
de un colaborador rige lo que puede hacer en todo el espacio de trabajo; el rol de un token
de emparejamiento rige lo que otorga ese emparejamiento específico con un archivo.
