...
short_description: "Source-of-truth inversion designates one storage layer canonical (signed record), a second derived (rebuilt on demand), and a third session-ephemeral (discarded)."
status: active
category: patterns
type: topic
content_type: topic
